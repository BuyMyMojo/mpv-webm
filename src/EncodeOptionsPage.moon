...
class EncodeOptionsPage extends Page
	new: (callback) =>
		...
		formatIds = {"webm-vp9", "vp9-qsv", "av1", "av1-qsv", "avc", "avc-qsv", "avc-qsv_opus", "avc-nvenc", "hevc", "hevc-nvenc", "webm-vp8",  "raw", "utvideo-yuv420p", "utvideo-yuv422p", "utvideo-yuv444p", "mp3", "ogg", "gif"}

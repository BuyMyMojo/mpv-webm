...
class EncodeOptionsPage extends Page
	new: (callback) =>
		...
		formatIds = {"webm-vp8", "webm-vp9", "webm-vp9-qsv", "webm-av1-qsv", "mp4", "mp4-nvenc", "mp4-x264QSV", "mp4-x264QSV_opus", "raw", "utvideo-yuv420p", "utvideo-yuv422p", "utvideo-yuv444p", "mp3", "ogg", "gif"}
		formatOpts =
